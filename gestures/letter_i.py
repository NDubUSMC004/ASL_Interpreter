def is_letter_i(landmarks, handedness):
    
    ''' I: Pinky pointed up on outside of hand, other fingers folded down, thumb straight up, thumb close to index'''
    ...
    return thumb_is_up and pinky_is_up and fingers_curled and thumb_close_to_index and pinky_outside