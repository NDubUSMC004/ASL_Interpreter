def is_letter_c(landmarks, handedness):
    
    ''' C: Fingers and thumb curved in shape of 'C' with fingers above thumb and the hand is sideways'''
    ...
    thumb_not_meets_fingers = (
        abs(thumb_tip.y - middle_tip.y) > 0.05
    )
    
    return fingers_above_thumb and fingers_curved and hand_is_sideways and thumb_not_meets_fingers