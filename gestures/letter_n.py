def is_letter_n(landmarks, handedness):
    
    ''' N: Fingers folded down, thumb under first two fingers, above pinky and ring finger'''
    ...
    thumb_under_middle = (
        ...
        (
            (middle_tip.x < thumb_tip.x) if is_right_hand
            else (thumb_tip.x < middle_tip.x)
        )
    )

    return fingers_curled and thumb_above_pinky and thumb_under_middle